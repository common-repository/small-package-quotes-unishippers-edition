...
class Unishippers_EnUnishippersSmallVa
{
    /**
    ...
    public function get_va_coupon_data_from_api(){
        ...
        $url = UNISHIPPERS_VA_COUPON_BASE_URL . "/use_coupon?".$data_encoded;
    ...
    public function get_va_coupon_parsed_data($va_coupon_data)
    {
        ...
        $parsed_data['register_url'] = UNISHIPPERS_VA_COUPON_BASE_URL.'/register?code='.$base64string;
        $parsed_data['login_url'] = UNISHIPPERS_VA_COUPON_BASE_URL.'/login?code='.$base64string;
        // $parsed_data['user_guide_get_started'] = UNISHIPPERS_VA_COUPON_BASE_URL.'/help/Getting_Started';
