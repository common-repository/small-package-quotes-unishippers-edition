 ...
 * Order widget page.
 */
if (!class_exists('Unishippers_EnOrderWidget')) {

    class Unishippers_EnOrderWidget
    {
        ...
        function en_order_actions($actions, $order)
        {
            ...
            add_meta_box('en_additional_order_details', __('Additional Order Details', 'eniture-unishippers-small-quotes'), [$this, 'en_order_widget'], get_current_screen()->id, 'side', 'low', 'core');
        ...
        public function en_show_order_widget($number_shipment, $sender_origin, $label, $cost, $accessorials, $items, $en_extra_accessories)
        {
            ...
            echo '<li>' . esc_attr($label) . ': ' . esc_attr( $this->en_format_price($cost)) . '</li>';
        ...
        public function en_show_accessorials($accessorials)
        {
            ...
            if (stripos(implode($all_plugins), 'residential-address-detection.php') || is_plugin_active_for_network('residential-address-detection/residential-address-detection.php')) {
                ...
                if($rad_status == false && get_option('suspend_automatic_detection_of_residential_addresses') != 'yes') {
                    unset($en_accessorials['residential']);
                }
            }
