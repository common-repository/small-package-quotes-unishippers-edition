 ...
 */
if (!class_exists('Unishippers_EnUniSpqOrderRates')) {

    class Unishippers_EnUniSpqOrderRates
    {
        ...
        public function eniture_calculate_shipping_rates_admin()
        {
            ...
            if (get_option('enable_backup_rates_unishippers_small') == 'yes' && count($prices) > 1) {
    ...
    new Unishippers_EnUniSpqOrderRates();
}
