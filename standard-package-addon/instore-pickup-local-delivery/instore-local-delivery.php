...
if (!class_exists("EnWDQuotes")) {
    ...
    class EnWDQuotes
    {
        ...
        public function en_wd_update_query_string()
        {
            ...
            return " ,phone_instore, enable_store_pickup , fee_local_delivery , fee_store_pickup , suppress_local_delivery , miles_store_pickup , match_postal_store_pickup , checkout_desc_store_pickup , enable_local_delivery , miles_local_delivery , match_postal_local_delivery , checkout_desc_local_delivery ";
        }
        ...
        public function en_wd_origin_array_set($origin)
        {
            ...
            $fee_store_pickup = (isset($origin->fee_store_pickup)) ? $origin->fee_store_pickup : "";
            ...
            $origin_array = array(
                ...
                'fee_store_pickup' => $fee_store_pickup,
