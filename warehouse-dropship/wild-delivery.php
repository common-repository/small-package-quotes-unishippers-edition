<?php
     ...
     */
    if(!function_exists("unishippers_en_woo_wd_admin_script_style"))
    {
        function unishippers_en_woo_wd_admin_script_style() 
        {
            ...
            wp_enqueue_script('en_woo_wd_script', plugin_dir_url(__FILE__) . '/wild/assets/js/warehouse_section.js', array(), '1.0.5');
        ...
        add_action('admin_enqueue_scripts', 'unishippers_en_woo_wd_admin_script_style');
    }
    
    /**
     * Warehouse Template
     */
    if(!function_exists('unishippers_warehouse_template'))
    {
        function unishippers_warehouse_template($action = FALSE){
            ...
            $tr_disabled_me = "";
            $add_space = "";
            $plugin_tab = (isset($_REQUEST['tab'])) ? sanitize_text_field( wp_unslash($_REQUEST['tab'])) : "";
        ...
        <div class="add_btn_warehouse">
            ...
            <div class="wild_warehouse pakage_notify heading_right">
                <?php echo esc_attr( $multi_warehouse_package_required ); ?>
            </div>
        <br><?php echo esc_attr( $add_space ); ?>
            ...
            <tbody>
                ...
                if (count($warehous_list) > 0) {
                    ...
                    foreach ($warehous_list as $list) {
                        ?>
                        <tr class="<?php echo (strlen($tr_disabled_me) > 0 && $count != 0) ? esc_attr( $tr_disabled_me ) : ""; ?>" id="row_<?php echo ( isset($list->id) ) ? esc_attr($list->id) : ''; ?>" data-id="<?php echo ( isset($list->id) ) ? esc_attr($list->id) : ''; ?>">
                            ...
                            <td class="en_wd_warehouse_list_data">
                                <a href="javascript(0)" onclick="return en_wd_edit_warehouse(<?php echo ( isset($list->id) ) ? esc_attr($list->id) : ''; ?>);"><img src="<?php echo esc_url_raw( plugins_url()); ?>/small-package-quotes-unishippers-edition/warehouse-dropship/wild/assets/images/edit.png" title="Edit"></a>
                                <a href="javascript(0)" onclick="return en_wd_delete_current_warehouse(<?php echo ( isset($list->id) ) ? esc_attr($list->id) : ''; ?>);"><img src="<?php echo esc_url_raw( plugins_url()); ?>/small-package-quotes-unishippers-edition/warehouse-dropship/wild/assets/images/delete.png" title="Delete"></a>
                            </td>
                        </tr>
                        <?php
                        $count++;
     ...
     * Dropship Template
     */
    if(!function_exists('unishippers_dropship_template'))
    {
        function unishippers_dropship_template($action = FALSE){
        ...
        <div class="add_btn_dropship">
            ...
            <div class="wild_warehouse pakage_notify heading_right">
                <?php echo esc_attr( $multi_dropship_package_required ); ?>
            </div>
        <br><?php echo esc_attr( $add_space ); ?>
        <div class="warehouse_text">
            ...
            <tbody>
                ...
                if (count($dropship_list) > 0) {
                    ...
                    foreach ($dropship_list as $list) {
                        ?>
                        <tr class="<?php echo (strlen($tr_disabled_me) > 0 && $count != 0) ? esc_attr( $tr_disabled_me ) : ""; ?>" id="row_<?php echo ( isset($list->id) ) ? esc_attr($list->id) : ''; ?>">
                            ...
                            <td class="en_wd_dropship_list_data">
                                <a href="javascript(0)" onclick="return en_wd_edit_dropship(<?php echo ( isset($list->id) ) ? esc_attr($list->id) : ''; ?>);"><img src="<?php echo esc_url_raw( plugins_url()); ?>/small-package-quotes-unishippers-edition/warehouse-dropship/wild/assets/images/edit.png" title="Edit"></a>
                                <a href="javascript(0)" onclick="return en_wd_delete_current_dropship(<?php echo ( isset($list->id) ) ? esc_attr($list->id) : ''; ?>);"><img src="<?php echo esc_url_raw( plugins_url()); ?>/small-package-quotes-unishippers-edition/warehouse-dropship/wild/assets/images/delete.png" title="Delete"></a>
                            </td>
                        </tr>
                        <?php
                        $count++;
