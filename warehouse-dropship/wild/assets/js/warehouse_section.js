    jQuery(document).ready(function() {
        ...
        // Origin terminal address
        // Terminal phone number
        jQuery("#en-phone-number, #en_wd_origin_address, #en_wd_origin_zip , #en_wd_origin_city , #en_wd_origin_state , #en_wd_origin_country, #instore-pickup-address, #instore-pickup-desc, #local-delivery-address, #local-delivery-desc, #local-delivery-fee, #instore-pickup-fee").focus(function (e) {
            jQuery("#add_warehouses #" + this.id).css({'border-color': '#ddd'});
        });

        // Origin terminal address
        // Terminal phone number
        jQuery("#en-phone-number, #en_wd_dropship_nickname, #en_wd_dropship_address, #en_wd_dropship_zip , #en_wd_dropship_city , #en_wd_dropship_state, #en_wd_dropship_country, #instore-pickup-address, #instore-pickup-desc, #local-delivery-address, #local-delivery-desc, #local-delivery-fee, #instore-pickup-fee").focus(function (e) {
            jQuery("#add_dropships #" + this.id).css({'border-color': '#ddd'});
        });

        jQuery("#en_wd_origin_zip , #en_wd_origin_city , #en_wd_origin_state , #en_wd_origin_country, #instore-pickup-address, #instore-pickup-desc, #local-delivery-address, #local-delivery-desc, #local-delivery-fee, #instore-pickup-fee").focus(function (e) {
            jQuery("#add_warehouses #"+this.id).css({'border-color' : '#ddd'});
        });

        jQuery("#en_wd_dropship_nickname , #en_wd_dropship_zip , #en_wd_dropship_city , #en_wd_dropship_state, #en_wd_dropship_country, #instore-pickup-address, #instore-pickup-desc, #local-delivery-address, #local-delivery-desc, #local-delivery-fee, #instore-pickup-fee").focus(function (e) {
            jQuery("#add_dropships #"+this.id).css({'border-color' : '#ddd'});
        });
        ...
        jQuery("._en_exempt_ground_transit_restriction").closest('p').addClass('_en_exempt_ground_transit_restriction');
        
        jQuery(".disabled_me").on('click' , function(){
            return false;
        });
        
        jQuery("#instore-pickup-address , #local-delivery-address , #local-delivery-fee, #instore-pickup-fee").keydown(function (e) {
    ...
    if(typeof instorePickupInputVal != 'function')
    {
        function instorePickupInputVal(formID)
        {
            ...
            var instorePickup = {
                ...
                'fee_instore' : jQuery(formID +' #instore-pickup-fee').val()
            };
   ...
   if(typeof load_inside_pikup_and_local_delivery_data != 'function')
    {
        function load_inside_pikup_and_local_delivery_data(data, formID)
        {
            ...
            jQuery(formID + ' #instore-pickup-fee').val(data[0]?.fee_store_pickup);
            // Terminal phone number
    ...
    if(typeof en_wd_save_warehouse != 'function')
    {
        function en_wd_save_warehouse()
        {
            ...
            const instore_pickup_fee = jQuery("#add_warehouses #instore-pickup-fee").val();
            ...
            switch(true)
            {
                ...
                case (enable_local_delivery &&
                    ...
                    jQuery("#add_warehouses #local-delivery-address").css({'border-color' : '#e81123'});
                    jQuery( '.content' ).delay( 200 ).animate({scrollTop: 0 }, 300);
                    setTimeout(function () {
                ...
                case (enable_local_delivery && local_delivary_fee?.length && !((/^\s*-?\d+(\.\d{1,2})?\s*$/).test(local_delivary_fee))):
                    jQuery('.dynamic_warehouse_error').show('slow');
                    jQuery('.dynamic_warehouse_error p').html('<strong>Error!</strong> Local delivery fee format should be 20.20 or 20.');
                ...
                case (enable_instore_pickup && instore_pickup_fee?.length && !((/^\s*-?\d+(\.\d{1,2})?\s*$/).test(instore_pickup_fee))):
                    jQuery('.dynamic_warehouse_error').show('slow');
                    jQuery('.dynamic_warehouse_error p').html('<strong>Error!</strong> Instore pickup fee format should be 20.20 or 20.');
                    jQuery("#add_dropships #instore-pickup-fee").css({'border-color' : '#e81123'});
                    jQuery('.content').delay( 200 ).animate({scrollTop: 0 }, 300);
                    setTimeout(function () {
                        jQuery('.dynamic_warehouse_error').hide('slow');
                    }, 5000);
            ...
            jQuery.ajax({
                ...
                success: function (data)
                {
                    ...
                    if (data.insert_qry == 1) {
                        ...
                        jQuery('tr[id=row_' + WarehpuseDataId + ']').html('<td class="en_wd_warehouse_list_data">' + data.origin_city + '</td><td class="en_wd_warehouse_list_data">' + data.origin_state + '</td><td class="en_wd_warehouse_list_data">' + data.origin_zip + '</td><td class="en_wd_warehouse_list_data">' + data.origin_country + '</td><td class="en_wd_warehouse_list_data"><a href="javascript(0)" title="Edit" onclick="return en_wd_edit_warehouse(' + WarehpuseDataId + ')"><img src="' + script.pluginsUrl + '/small-package-quotes-unishippers-edition/warehouse-dropship/wild/assets/images/edit.png"></a><a href="javascript(0)" title="Delete" onclick="return en_wd_delete_current_warehouse(' + WarehpuseDataId + ');"><img src="' + script.pluginsUrl + '/small-package-quotes-unishippers-edition/warehouse-dropship/wild/assets/images/delete.png"></a></td>');
    ...
    if(typeof en_wd_save_dropship != 'function')
    {
        function en_wd_save_dropship()
        {
            ...
            const dropship_instore_pickup_fee = jQuery("#add_dropships #instore-pickup-fee").val();
            ...
            switch(true)
            {
                ...
                case (enable_local_delivery &&
                    ...
                    jQuery('.wrng_local').show('slow');
                    jQuery("#add_dropships #local-delivery-address").css({'border-color' : '#e81123'});
                    jQuery( '.content' ).delay( 200 ).animate({scrollTop: 0 }, 300);
                    setTimeout(function () {
                        jQuery('.wrng_local').hide('slow');
                    }, 5000);
                ...
                case (enable_local_delivery && dropship_local_delivary_fee?.length && !((/^\s*-?\d+(\.\d{1,2})?\s*$/).test(dropship_local_delivary_fee))):
                    jQuery('.dynamic_dropship_error').show('slow');
                    jQuery('.dynamic_dropship_error p').html('<strong>Error!</strong> Local delivery fee format should be 20.20 or 20.');
                    jQuery("#add_dropships #local-delivery-fee").css({'border-color' : '#e81123'});
                    jQuery('.content').delay( 200 ).animate({scrollTop: 0 }, 300);
                    setTimeout(function () {
                ...
                case (enable_local_delivery && dropship_local_delivary_fee?.length && dropship_local_delivary_fee?.split('.')[0]?.length > 4):
                    ...
                    jQuery("#add_dropships #local-delivery-fee").css({'border-color' : '#e81123'});
                    return false;
                case (enable_local_delivery && dropship_local_delivary_fee?.length && dropship_local_delivary_fee?.split('.')[1]?.length > 2):
                    jQuery("#add_dropships #local-delivery-fee").parent().find(".en_wd_err").html("Local delivery fee format should be 100.20 or 10% and only 2 digits are allowed after decimal point.");
                    jQuery("#add_dropships #local-delivery-fee").css({'border-color' : '#e81123'});
                    return false;
                
                case (enable_instore_pickup && dropship_instore_pickup_fee?.length && !((/^\s*-?\d+(\.\d{1,2})?\s*$/).test(dropship_instore_pickup_fee))):
                    jQuery('.dynamic_dropship_error').show('slow');
                    jQuery('.dynamic_dropship_error p').html('<strong>Error!</strong> Instore pickup fee format should be 20.20 or 20.');
                    jQuery("#add_dropships #instore-pickup-fee").css({'border-color' : '#e81123'});
                    jQuery( '.content' ).delay( 200 ).animate({scrollTop: 0 }, 300);
                    setTimeout(function () {
                        jQuery('.dynamic_dropship_error').hide('slow');
                ...
                case (enable_instore_pickup && dropship_instore_pickup_fee?.split('.')[0]?.length > 4):
                    jQuery("#add_dropships #instore-pickup-fee").parent().find(".en_wd_err").html("Instore pickup fee format should be 100.20 or 10% and only 2 digits are allowed after decimal point.");
                    jQuery("#add_dropships #instore-pickup-fee").css({'border-color' : '#e81123'});
                    return false;
                case (enable_instore_pickup && dropship_instore_pickup_fee?.split('.')[1]?.length > 2):
                    jQuery("#add_dropships #instore-pickup-fee").parent().find(".en_wd_err").html("Instore pickup fee format should be 100.20 or 10% and only 2 digits are allowed after decimal point.");
                    jQuery("#add_dropships #instore-pickup-fee").css({'border-color' : '#e81123'});
                    return false;
                ...
                case (enable_local_delivery && dropship_local_delivery_desc.length > 25):
                    jQuery('.dynamic_dropship_error').show('slow');
                    jQuery('.dynamic_dropship_error p').html('<strong>Error!</strong> Maximum 20 Alpha characters are allowed for checkout description.');
            ...
            jQuery.ajax({
                ...
                success: function (data)
                {
                    ...
                    if (data.insert_qry == 1) {
                        ...
                        jQuery('tr[id=row_' + WarehpuseDataId + ']').html('<td class="en_wd_dropship_list_data">' + data.nickname + '</td><td class="en_wd_dropship_list_data">' + data.origin_city + '</td><td class="en_wd_dropship_list_data">' + data.origin_state + '</td><td class="en_wd_dropship_list_data">' + data.origin_zip + '</td><td class="en_wd_dropship_list_data">' + data.origin_country + '</td><td class="en_wd_dropship_list_data"><a href="javascript(0)" title="Edit" onclick="return en_wd_edit_dropship(' + WarehpuseDataId + ')"><img src="' + script.pluginsUrl + '/small-package-quotes-unishippers-edition/warehouse-dropship/wild/assets/images/edit.png"></a><a href="javascript(0)" title="Delete" onclick="return en_wd_delete_current_dropship(' + WarehpuseDataId + ');"><img src="' + script.pluginsUrl + '/small-package-quotes-unishippers-edition/warehouse-dropship/wild/assets/images/delete.png"></a></td>');
