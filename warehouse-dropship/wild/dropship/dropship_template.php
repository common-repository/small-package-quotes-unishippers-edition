...
<script type="text/javascript">
    ...
    function change_dropship_zip()
    {
        ...
        jQuery('#en_wd_dropship_city').css('background', 'rgba(255, 255, 255, 1) url("<?php echo esc_url_raw( plugins_url() ); ?>/small-package-quotes-unishippers-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
        jQuery('#en_wd_dropship_state').css('background', 'rgba(255, 255, 255, 1) url("<?php echo esc_url_raw( plugins_url() ); ?>/small-package-quotes-unishippers-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
        ...
        jQuery('#en_wd_dropship_country').css('background', 'rgba(255, 255, 255, 1) url("<?php echo esc_url_raw( plugins_url() ); ?>/small-package-quotes-unishippers-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
...
<div class="en_wd_setting_section">
    ...
    <div id="delete_dropship_btn" class="en_wd_warehouse_overlay">
        <div class="en_wd_add_warehouse_popup">
            ...
            <p class="delete_p">
                Warning! If you delete this location, Drop ship location settings will be disabled against products if any.
            </p>
            <div class="del_btns">
    ...
    <?php unishippers_dropship_template(); ?>
            ...
            <div class="content">
                ...
                -->
                    <div class="heading">
                        ...
                        <a href="#">
                            <h2 class="warehouse_heading pakage_notify_instore_dropship heading_right"><?php echo esc_attr( $package_required); ?></h2>
                        </a>
                    </div>
                ...
                -->
                    ...
                    <div class="heading">
                        ...
                        <a href="#">
                            <h2 class="local-delivery-heading pakage_notify_local_dropship heading_right"><?php echo esc_attr( $package_required ); ?></h2>
                        </a>
                    </div>
