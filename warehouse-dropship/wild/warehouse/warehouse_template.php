...
<script type="text/javascript">
    jQuery(document).ready(function () {
        ...
        jQuery("#en_wd_origin_zip").keydown(function (e) {
            if (e.which != 96 && e.which != 8 && e.which != 0 && (e.which < 48 || e.which > 57) && (e.keyCode < 65 || e.keyCode > 90) && (e.keyCode < 97 || e.keyCode > 122) && e.which != 9) {
                return false;
            }
            else{
    ...
    function change_warehouse_zip()
    {
        ...
        jQuery('#en_wd_origin_city').css('background', 'rgba(255, 255, 255, 1) url("<?php echo esc_url_raw( plugins_url() ); ?>/small-package-quotes-unishippers-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
        jQuery('#en_wd_origin_state').css('background', 'rgba(255, 255, 255, 1) url("<?php echo esc_url_raw( plugins_url() ); ?>/small-package-quotes-unishippers-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
        jQuery('.city_select_css').css('background', 'rgba(255, 255, 255, 1) url("<?php echo esc_url_raw( plugins_url() ); ?>/small-package-quotes-unishippers-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
        jQuery('#en_wd_origin_country').css('background', 'rgba(255, 255, 255, 1) url("<?php echo esc_url_raw( plugins_url() ); ?>/small-package-quotes-unishippers-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
...
<div class="en_wd_setting_section">
    ...
    <?php unishippers_warehouse_template(); ?>
        ...
        <div class="en_wd_add_warehouse_popup">
            ...
            <div class="content" style="overflow-y: scroll; height: 500px;">
                ...
                <form method="post" id="add_warehouses">
                    ...
                    <!-- Origin level handling fee / markup -->
                    <div class="en_wd_add_warehouse_input">
                ...
                -->
                    <div class="heading">
                        ...
                        <a href="#">
                            <h2 class="warehouse_heading pakage_notify_instore_warehouse heading_right"><?php echo esc_attr( $package_required ); ?></h2>
                        </a>
                    </div>
                    ...
                    <div class="en_wd_add_warehouse_input">
                        <label>In-store pick up fee</label>
                        <input type="text" class="<?php echo $disabled; ?>" title="In-store pick up fee" data-optional="1" onchange="validate_delivery_fee(this);" id="instore-pickup-fee" name="instore-pickup-fee" maxlength="10">
                        <span class="en_wd_err"></span>
                    </div>
                    <!-- Terminal phone number -->
                    <div class="en_wd_add_warehouse_input">
                        <label>Phone number:</label>
                        <input type="text" class="<?php echo esc_attr( $disabled ); ?> en-phone-number" title="Phone number:" id="en-phone-number"
                ...
                -->
                    ...
                    <div class="heading">
                        ...
                        <a href="#">
                            <h2 class="local-delivery-heading pakage_notify_local_warehouse heading_right"><?php echo esc_attr( $package_required ); ?></h2>
                        </a>
                    </div>
                    ...
                    <div class="en_wd_add_warehouse_input">
                        ...
                        <input type="text" class="<?php echo esc_attr( $disabled); ?>" title="Local delivery fee" data-optional="1" onchange="validate_delivery_fee(this);" id="local-delivery-fee" name="local-delivery-fee" maxlength="10">
                        <span class="en_wd_err"></span>
                    </div>
                    <div class="en_wd_add_warehouse_input">
